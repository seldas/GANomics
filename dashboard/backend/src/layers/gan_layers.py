...
class FullyConnectedGenerator(nn.Module):
    ...
    def __init__(self, input_dim: int, output_dim: int):
        ...
        self.conv1 = nn.Conv2d(input_dim, math.floor(input_dim / 2), kernel_size=1)
        self.conv2 = nn.Conv2d(math.floor(input_dim / 2), output_dim, kernel_size=1)
...
class FullyConnectedDiscriminator(nn.Module):
    ...
    def __init__(self, input_dim: int):
        ...
        self.conv1 = nn.Conv2d(input_dim, math.floor(input_dim / 2), kernel_size=1)
        self.conv2 = nn.Conv2d(math.floor(input_dim / 2), 1, kernel_size=1)
        self.relu = nn.ReLU(inplace=True)
