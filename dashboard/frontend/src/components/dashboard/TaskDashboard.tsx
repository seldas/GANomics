...
export const TaskDashboard: React.FC<TaskDashboardProps> = ({
  ...
  if (taskView === 'deg') return <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}><div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}><button className="chip" onClick={() => onSetTaskView('overview')}><ArrowLeft size={18} /></button><h2 style={{ margin: 0 }}>DEG Analysis</h2></div><DegAnalysis data={runDegData} runId={selectedRunId} /></div>;
