...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('-t', '--size', default=400, help='Sample size')
        parser.add_argument('-r', '--run', default=1, help='current repeat/run')
        parser.add_argument('-n', '--network', default='FEEDBACKv2', help='network style')
        parser.add_argument('--ckp_dir', default='run/', help='result/checkpoint output directory')
        # basic parameters
    ...
    def parse(self):
        """Parse our options, create checkpoints_paired_80 directory suffix, and set up gpu device."""
